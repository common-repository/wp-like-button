...
class CLLBtnSettings {
    ...
    public function activePlugin() {
        if (isset($_POST['nonce']) && wp_verify_nonce($_POST['nonce'], 'crudlab_fblb_nonce_action')) {
            global $wpdb;
    ...
    public function registerJSCSS() {
        ...
        wp_localize_script('my-admin-js', 'crublabFBLBAjax', array(
            'nonce' => wp_create_nonce('crudlab_fblb_nonce_action'),
    ...
    public function saveData() {
        if (!is_user_logged_in() || !(isset($_POST['nonce']) && wp_verify_nonce($_POST['nonce'], 'fblikebtn'))) {
                        ...
                        <div class="fblb_col" style="width:67%; ">
                            <div class="fblb_where">
                                <form class="fblb_inline-form fblb_form-inline" method="post">
                                    <?php $nonce = wp_create_nonce('fblikebtn'); ?>
                                            ...
                                            <tr class="fblb_manual">
                                                ...
                                                <td>
                                                    <div class="fblb_form-group">   
                                                        ...
                                                        <a href="https://developers.facebook.com/docs/development/create-an-app/" target="_blank" title="Register Your Site on Facebook">Create new App ID</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="fblb_manual">
